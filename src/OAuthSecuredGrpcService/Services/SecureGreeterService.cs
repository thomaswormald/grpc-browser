...
namespace OAuthSecuredGrpcService.Services
{
    public class SecureGreeterService: SecureProtoFirstGreeter.SecureProtoFirstGreeterBase
    {
        private readonly ILogger<SecureGreeterService> _logger;
        public SecureGreeterService(ILogger<SecureGreeterService> logger)
        {
            _logger = logger;
        }
